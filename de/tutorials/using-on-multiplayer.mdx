...
<Info>
If a player does not have the client mod, MineClawd still has a fallback question flow in chat (`/mineclawd choose ...`).
</Info>

<Info>
Without client mod, you can still use `/mineclawd config <key> <value>` in chat for configuration.
</Info>
