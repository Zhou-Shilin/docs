...
MineClawd is a Minecraft mod that lets you ask for changes in plain language.

You type what you want. MineClawd can do the work in your world.
...
<CardGroup cols={2}>
  <Card title="Getting started" icon="rocket" href="/quickstart">
    Start from zero and send your first working message with the GUI path.
  </Card>
  <Card title="Tutorials" icon="book-open" href="/tutorials/managing-sessions">
    Go deeper with advanced guides for sessions, multiplayer, and persona design.
  </Card>
  ...
  <Card title="Technical details" icon="code" href="/resources/technical-details">
    Understand storage, tool loops, dynamic placeholders, and networking.
  </Card>
</CardGroup>
